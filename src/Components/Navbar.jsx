                ...
                <div className='menuContainer' style={{ backgroundColor: colorB }}>
                    <header className="header" style={{ backgroundColor: colorB }}>
                        ...
                        <div className='menuTop'>
                            <Link to={`/products`} state={{ query: 'WomenData' }}>
                                <span>WOMAN</span>
                            </Link>
                            <Link to={`/products`} state={{ query: 'Polo_shirt' }}>
                                <span>MENS</span>
                            </Link>
                            <Link to={`/products`} state={{ query: 'KidsData' }}>
                                <span>KIDS</span>
                            </Link>
                            <Link to={`/products`} state={{ query: 'product' }}>
                                <span>ZARA ORIGINS</span>
                            </Link>
                        </div>
                        <ul className="menu" style={{overflow:"auto"}}>
                            {menuItem.map((ele, index) => (
                                <li key={index} htmlFor="menu-btn"><Link to={`/products`}state={{ query: 'product' }} style={ele === 'Special Prices' ? { color: 'rgb(245, 57, 147)' } : {}}>{ele}</Link></li>
                            ))}
                        </ul>
                    </header>
                    <div className='logo'>
